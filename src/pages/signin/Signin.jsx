...
class Signin extends Component {
  ...
  checkValidation = () => {
    ...
    return (isError =
      errorsstate.mailorphoneError || errorsstate.passwordError);
  };
      ...
      <div className="signin-page">
        ...
        <div className="body-signin">
          ...
          <div className="forgot">
            <Link to="/forgotmail" className="link-signup">
              <p className="instead-signup forgot-signin">Forgot e-mail?</p>
            </Link>
          </div>
          ...
          <div className="forgot">
            <a href="#" className="link-signup">
              <p className="instead-signup forgot-signin">Forgot password?</p>
            </a>
          </div>
          <div className="signup-end">
            <Link className="link-signup" to="/signup">
              <p className="instead-signup">Create account</p>
            </Link>
            <a href="#" className="link-signup">
