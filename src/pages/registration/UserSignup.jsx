...
class Usersignup extends Component {
    ...
    checkValidation = () => {
        ...
        return isError = errorsstate.fnameError || errorsstate.lnameError || errorsstate.usernameError || errorsstate.passwordError || errorsstate.confirmpassError ;
    }
                ...
                <div className='main-signup'>
                    ...
                    <div className='name-signup'>
                        <div className='textfield'>
                            ...
                            helperText={this.state.fnameError ? "First name is required" : ''}
                            />
                        </div>
                        <div className='textfield'>
                            <TextField 
                            ...
                            // onInput={this.next}
                            onChange={e => this.change(e)}
                            helperText={this.state.lnameError ? 'Last name is required' : ''}
                            />
                        </div>
                    ...
                    <div className='textfield'>
                        ...
                        onChange={e => this.change(e)}
                        helperText={this.state.confirmpassError ? 'Confirm password required' : ''}
                         />
                    </div>
                    </div>
                    ...
                    <div className='signup-end'>
                        <Link to='/' className='link-signup'><p className='instead-signup'>Sign in instead</p></Link>
